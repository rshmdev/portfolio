...
const works = [
  ...
  },
  {
    ...
    methods: [
      "Liderança técnica e arquitetura do sistema",
      "Desenvolvimento full-stack da plataforma",
      "Integração com dispositivos IoT industriais",
      "Implementação de algoritmos de IA para análise preditiva",
    ],
    benefits: [
      "Revoluciona processos de manutenção industrial",
      "Reduz custos operacionais através de manutenção preditiva",
      "Aumenta eficiência e produtividade das operações",
      "Fornece insights em tempo real sobre equipamentos",
    ],
    results: [
      "Projeto desenvolvido do zero como líder técnico",
      "Solução enterprise em produção",
      "Transformação digital de processos industriais",
    ],
  },
  {
    id: 3,
    ...
    methods: [
      "Desenvolvimento completo da plataforma do zero",
      "Arquitetura de sistema para gestão cultural",
      "Interface intuitiva para diferentes tipos de usuários",
      "Sistema de conexão entre artistas e patrocinadores",
    ],
    benefits: [
      "Democratiza acesso à gestão cultural profissional",
      "Facilita encontro entre talento e oportunidade",
      "Fortalece ecossistema cultural brasileiro",
      "Oferece ferramentas modernas para criadores culturais",
    ],
    results: [
      "Projeto desenvolvido integralmente do zero",
      "Plataforma completa para gestão de projetos culturais",
      "Contribuição para fortalecimento da cultura brasileira",
    ],
  },
  {
    id: 4,
    ...
    methods: [
      "Desenvolvimento mobile nativo multiplataforma",
      "Sistema de gamificação com moedas e XP",
      "Integração com sistema escolar existente",
      "Implementação de QR Code para acesso dos alunos",
    ],
    benefits: [
    ...
    results: [
      "Aplicativo em produção em escola com 200+ alunos",
      "Sistema totalmente integrado ao ambiente escolar",
      "Impacto positivo comprovado no engajamento estudantil",
    ],
  },
  {
    id: 5,
    ...
    methods: [
      "Desenvolvimento de painel administrativo completo",
      "Implementação de sistema RBAC para controle de acesso",
      "Interface intuitiva para gestão escolar",
      "Integração total com aplicativo mobile",
    ],
    benefits: [
      "Controle total sobre experiência de gamificação",
      "Interface intuitiva para educadores",
      "Gestão eficaz de recompensas e progressos",
      "Alinhamento com objetivos pedagógicos",
    ],
    results: [
      "Painel administrativo robusto em produção",
      "Sistema de controle de acesso baseado em funções",
      "Ferramenta essencial para gestão da gamificação escolar",
    ],
  },
];
